!(function(e, t) {
  ...
  var w,
    ...
    function(e, t, r) {
      ...
      if (w && t != t) {
        ...
        for (; a > s; s++) if ((w || s in o) && o[s] === t) return w || s || 0;
      return !w && -1;
    }),
  ...
  var Y = H.Logger,
    ...
    ee = (function(e) {
      ...
      return (
        ...
        (MKError.AUTHORIZATION_ERROR = J[2002]),
        (MKError.CONFIGURATION_ERROR = "CONFIGURATION_ERROR"),
        (MKError.CONTENT_EQUIVALENT = "CONTENT_EQUIVALENT"),
        (MKError.CONTENT_RESTRICTED = J[3082]),
        (MKError.CONTENT_UNAVAILABLE = J[3076]),
        (MKError.DEVICE_LIMIT = J[3059]),
        ...
        (MKError.NOT_FOUND = J[1010]),
        (MKError.PLAY_ACTIVITY = "PLAY_ACTIVITY"),
        (MKError.QUOTA_EXCEEDED = Z[429]),
        (MKError.REQUEST_ERROR = Z[400]),
        (MKError.SERVER_ERROR = J[5002]),
        (MKError.SERVICE_UNAVAILABLE = Z[503]),
        (MKError.STREAM_UPSELL = J[3084]),
        (MKError.SUBSCRIPTION_ERROR = J[3063]),
        (MKError.TOKEN_EXPIRED = J[2034]),
  ...
  function formattedMediaURL(e) {
    ...
    var t = e.match(te),
      ...
      o = t[4];
    return (
      -1 !== ["album", "playlist"].indexOf(i) && o && ((i = "song"), (n = o)),
                ...
                return o(this, function(o) {
                  switch (o.label) {
                    ...
                    case 1:
                      return (
                        o.trys.push([1, 3, , 4]),
                        [4, r.apply(null, Ce.ensureArray(e.params))]
                      );
                    case 2:
                      return (
                        (n = o.sent()), [2, Object.assign(t, { result: n })]
                      );
                    case 3:
                      return (
                        (a = o.sent()),
      ...
      return (
        Object.defineProperty(ServiceSetupView.prototype, "isServiceView", {
          get: function() {
            return (
              (window &&
                /(authorize\.(.+\.)*apple\.com|apps\.mzstatic\.com)/i.test(
  ...
  unwrapExports(xe);
  xe.AuthorizationStatus,
    xe.validateToken,
    xe.AUTHENTICATE_REQUEST_URL,
    xe.SERVICE_URL,
    xe.SUBSCRIBE_URL,
    xe.WHITELIST_DOMAIN_REGEX,
    xe.ServiceSetupAction,
    xe.ServiceSetupView;
  ...
  var je = Ue.Defaults,
    ...
    createCommonjsModule(function(e, r) {
      ...
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.validateToken = xe.validateToken),
        (r.AuthorizationStatus = xe.AuthorizationStatus),
        (function(e) {
      ...
      var u = (function(e) {
        function StoreKit(t, r) {
          ...
          return (
            ...
            (i._authorizationStatus = xe.AuthorizationStatus.NOT_DETERMINED),
            ...
            (i._developerToken = new Se.DeveloperToken(t)),
            (i._serviceSetupView = new xe.ServiceSetupView(t, {
              iconURL: r && r.iconURL,
            ...
            i.userTokenIsValid &&
              ...
              (i._authorizationStatus = i.restrictedEnabled
                ? xe.AuthorizationStatus.RESTRICTED
                : xe.AuthorizationStatus.AUTHORIZED)),
        ...
        return (
          ...
          (StoreKit.prototype.itunesDeeplinkURL = function(e) {
            return (
              void 0 === e && (e = { p: "browse" }),
              (e = Object.assign(this.deeplinkParameters || {}, e)),
              "https://itunes.apple.com/deeplink?" + Ae.buildQueryParams(e)
            );
          }),
                ...
                switch (t.label) {
                  case 0:
                    return this.storefrontIdentifier
                      ...
                      : [
                          4,
                          Ue.Storefront.inferFromLanguages(this.developerToken)
                        ];
                  case 1:
                    (e = t.sent()),
          ...
          (StoreKit.prototype._migrateStorageItem = function(e) {
            ...
            this.storage &&
              e &&
              ("cookie" === this.persist
                ? (t = this.storage.getItem(e)) && this.storage.removeItem(e)
                : "localstorage" === this.persist &&
                  (t = ne.getCookie(btoa(e))) &&
                  ne.setCookie(btoa(e), "", "", 0),
              t && this._setStorageItem(e, t));
          }),
          ...
          (StoreKit.prototype._reset = function(e) {
            void 0 === e && (e = xe.AuthorizationStatus.NOT_DETERMINED),
              (this._authorizationStatus = e),
              (this._cid = void 0),
  ...
  var Ke = Be.AuthorizationStatus,
    ...
    Fe = createCommonjsModule(function(e, t) {
      function get(e, t) {
      ...
      var r = (function() {
        ...
        return (
          ...
          (DataRecord.prototype.serialize = function() {
            var e = this,
              t = { id: this.id, type: this.type };
            return (
              this.hasAttributes() &&
                (t.attributes = this._attributes.reduce(function(t, r) {
                  return (t[r] = e[r]), t;
                }, {})),
              this._relationships.length > 0 &&
                (t.relationships = this._relationships.reduce(function(t, r) {
                  return (t[r] = e[r]), t;
                }, {})),
              { data: t }
            );
        ...
        return (
          ...
          (DataStore.prototype.save = function(e, t) {
            ...
            return (
              ...
              Ce.ensureArray(e.data).map(function(e) {
                var i = r._materializeRecord(e.type, e.id);
                return (
                  t && Object.assign(e, Fe.transform(t, e)),
                  e.attributes
          ...
          (DataStore.prototype._materializeRecord = function(e, t) {
            return (
              ...
              (this._records[e][t] = this._records[e][t] || new r(e, t)),
              this._records[e][t]
            );
          }),
          DataStore
  ...
  We.DataRecord;
  var Ge = We.DataStore,
    Qe = createCommonjsModule(function(e, r) {
      var i,
        n =
          (t && t.__extends) ||
          ((i =
      ...
      var s = (function() {
        ...
        return (
          (URLSession.prototype.request = function(e, t) {
                ...
                switch (a.label) {
                    ...
                    return (
                      ...
                      t &&
                        ...
                        ((i = Object.keys(t)
                          ...
                          .join("&")),
                        (r = r + "?" + i)),
                      (n = this.getCacheItem(r))
                        ? [2, Promise.resolve(n)]
                        : ((o = { method: this.method, headers: this.headers }),
                          t &&
                            "POST" === this.method &&
                  ...
                  case 1:
                    return (s = a.sent()).ok
                      ...
                      : [2, Promise.reject(s)];
                  case 2:
                    return (u = a.sent()).errors
                      ? [2, Promise.reject(u.errors)]
                      : ((c = u.results || u.data || u),
                        this.setCacheItem(r, c),
                        [2, c]);
                }
              });
            });
      ...
      var u = (function(e) {
        function TokenSession(t, r, i, n) {
          ...
          return (
            (o._developerToken = new Se.DeveloperToken(r)),
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(n) {
              switch (n.label) {
                ...
                case 3:
                  return (
                    (i = n.sent()), [2, Promise.reject(ee.responseError(i))]
                  );
                case 4:
                  return [2];
              }
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(i) {
              return (
                ...
                [2, this.collection("search", void 0, r)]
              );
            });
          });
        }),
              ...
              switch (o.label) {
                case 0:
                  !t ||
                    ...
                    (i = t ? Object.assign({ ids: t.join(",") }, r) : r),
                    (o.label = 1);
                case 1:
                  return (
                    o.trys.push([1, 3, , 4]), [4, this.request(Je + "/" + e, i)]
                  );
                case 2:
                  return [2, o.sent()];
                case 3:
  ...
  var et,
    ...
    it = (function(e) {
      function API(t, r, i, n, o) {
        ...
        return (
          (a.storefrontId = je.ID),
          (a.enableDataStore = !!we.features["api-data-store"]),
          (a.enablePlayEquivalencies = !!we.features.equivalencies),
          a.enableDataStore && (a._store = new Ge()),
          i && (a.storefrontId = i),
          n && o && (a.userStorefrontId = o),
          (a.library = new $e(t, r, n)),
          a
        );
      }
      return (
        __extends(API, e),
        Object.defineProperty(API.prototype, "hasDataStore", {
          get: function() {
        ...
        (API.prototype.activity = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(Ze.Catalog, "activities", e, t)];
            });
          });
        }),
        (API.prototype.activities = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(Ze.Catalog, "activities", e, t)];
            });
          });
        }),
          ...
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                ...
                [2, this.resource(Ze.Catalog, "albums", e, t)]
              );
            });
          });
        }),
        (API.prototype.albums = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                (t = this.equivalentParameters(t, "extend[songs]")),
                [2, this.collection(Ze.Catalog, "albums", e, t)]
              );
            });
          });
        }),
        (API.prototype.appleCurator = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(Ze.Catalog, "apple-curators", e, t)];
            });
          });
        }),
        (API.prototype.appleCurators = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(Ze.Catalog, "apple-curators", e, t)];
            });
          });
        }),
        (API.prototype.artist = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(Ze.Catalog, "artists", e, t)];
            });
          });
        }),
        (API.prototype.artists = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(Ze.Catalog, "artists", e, t)];
            });
          });
        }),
        (API.prototype.charts = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(Ze.Catalog, "charts", e, t)];
            });
          });
        }),
        (API.prototype.curator = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(Ze.Catalog, "curators", e, t)];
            });
          });
        }),
        (API.prototype.curators = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(Ze.Catalog, "curators", e, t)];
            });
          });
        }),
        (API.prototype.genre = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(Ze.Catalog, "genres", e, t)];
            });
          });
        }),
        (API.prototype.genres = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(Ze.Catalog, "genres", e, t)];
            });
          });
        }),
          ...
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                ...
                [2, this.resource(Ze.Catalog, "music-videos", e, t)]
              );
            });
          });
        }),
        (API.prototype.musicVideos = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                (t = this.equivalentParameters(t)),
                [2, this.collection(Ze.Catalog, "music-videos", e, t)]
              );
            });
          });
        }),
        (API.prototype.playlist = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(Ze.Catalog, "playlists", e, t)];
            });
          });
        }),
        (API.prototype.playlists = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(Ze.Catalog, "playlists", e, t)];
            });
          });
        }),
        ...
        (API.prototype.recommendation = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [
                2,
                this.resource(Ze.Personalized, "recommendations", e, t)
              ];
            });
          });
        }),
        (API.prototype.recommendations = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [
                2,
                this.collection(Ze.Personalized, "recommendations", e, t)
              ];
            });
          });
        }),
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(i) {
              return (
                ...
                [2, this.collection(Ze.Catalog, "search", void 0, r)]
              );
            });
          });
        }),
        (API.prototype.searchHints = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(i) {
              return (
                (r = Object.assign({ term: e }, transformParameters(t))),
                [2, this.collection(Ze.Catalog, "search/hints", void 0, r)]
              );
            });
          });
        }),
        (API.prototype.song = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                (t = this.equivalentParameters(t)),
                [2, this.resource(Ze.Catalog, "songs", e, t)]
              );
            });
          });
        }),
          ...
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                ...
                (t = this.equivalentParameters(t)),
                [2, this.collection(Ze.Catalog, "songs", e, t)]
              );
            });
          });
        }),
        (API.prototype.station = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(Ze.Catalog, "stations", e, t)];
            });
          });
        }),
        (API.prototype.stations = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(Ze.Catalog, "stations", e, t)];
            });
          });
        }),
        (API.prototype.storefront = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(Ze.Global, "storefronts", e, t)];
            });
          });
        }),
        (API.prototype.storefronts = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(Ze.Global, "storefronts", e, t)];
            });
          });
        }),
              ...
              switch (l.label) {
                    ...
                    case Ze.Catalog:
                      (s = this.storefrontId),
                        this.needsEquivalents &&
                          "playlists" === t &&
                          (s = this.userStorefrontId),
                        (a = e + "/" + s + "/" + t);
                      break;
                    case Ze.Global:
                      a = t;
                      break;
                    case Ze.Personalized:
                      a = e + "/" + t;
                  }
                  l.label = 1;
                case 1:
                ...
                case 2:
                  return 0 === (u = l.sent()).length
                    ...
                    : this.hasDataStore
                    ? [2, this._store.save({ data: u })]
                    : [2, u];
                case 3:
                  return (
                    (c = l.sent()), [2, Promise.reject(ee.responseError(c))]
                  );
                case 4:
                  return [2];
              }
              ...
              switch (o.label) {
                case 0:
                  return this.hasDataStore &&
                    (n = this._store.peek(t, r)) &&
                    n.hasAttributes
                    ? [2, n]
                    : [4, this.collection(e, t, [r], i)];
                case 1:
                  return [2, o.sent()[0]];
              }
            });
  ...
  ((et = e.PlaybackBitrate || (e.PlaybackBitrate = {}))[(et.STANDARD = 64)] =
    "STANDARD"),
    (et[(et.HIGH = 256)] = "HIGH"),
    (function(e) {
    ...
    ((rt = e.PlaybackStates || (e.PlaybackStates = {}))[(rt.none = 0)] =
      "none"),
    (rt[(rt.loading = 1)] = "loading"),
    (rt[(rt.playing = 2)] = "playing"),
    (rt[(rt.paused = 3)] = "paused"),
    (rt[(rt.stopped = 4)] = "stopped"),
    (rt[(rt.ended = 5)] = "ended"),
    (rt[(rt.seeking = 6)] = "seeking"),
    (rt[(rt.waiting = 8)] = "waiting"),
    (rt[(rt.stalled = 9)] = "stalled"),
    (rt[(rt.completed = 10)] = "completed");
  var nt = Ve.playbackBitrateDidChange,
    ot = Ve.playbackStateDidChange,
    at = Ve.playbackStateWillChange,
    st = Ve.playbackTargetAvailableDidChange,
    ut = (function(t) {
      function Playback(r) {
        void 0 === r && (r = []);
        var i = t.call(this, [nt, ot, at, st].concat(r)) || this;
        return (
      ...
      return (
        ...
        Object.defineProperty(Playback.prototype, "bitrate", {
          ...
          set: function(e) {
            this._bitrate !== e &&
              ((this._bitrate = e), this.dispatchEvent(nt, { bitrate: e }));
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(Playback.prototype, "playbackTargetAvailable", {
          ...
          set: function(e) {
            (this._playbackTargetAvailable = e),
              this.dispatchEvent(st, { available: e });
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(Playback.prototype, "previewOnly", {
          get: function() {
            return this._mode === tt.PREVIEW_ONLY;
          },
          set: function(e) {
            this._mode = e ? tt.PREVIEW_ONLY : tt.DEFAULT;
          },
          enumerable: !0,
          configurable: !0
        }),
          ...
          get: function() {
            if (!this._byteRanges) {
              var e = (function(e) {
                ...
                t = (function(e) {
                  if (e && lt.test(e))
                    return e.match(lt).map(function(e) {
                ...
                n = t.map(function(e) {
                  var t = e[0],
                    r = e[1];
                  return new mt({ url: i, startByte: r, length: t });
                }),
                o = e.byterange.split("@"),
                a = o[0],
                s = o[1];
              n.unshift(new mt({ url: i, startByte: s, length: a })),
                (this._byteRanges = n);
            }
  ...
  var bt,
    ...
    gt = (function(e) {
      function KeySession() {
        var t =
          e.call(this, [ft.playbackLicenseError, ft.playbackSessionError]) ||
          this;
        return (
          (t.initiated = !0),
          (t.isLibrary = !1),
          (t.keySystem = ht.FAIRPLAY),
      ...
      return (
        ...
        Object.defineProperty(KeySession.prototype, "isFairplay", {
          get: function() {
            return this.keySystem === ht.FAIRPLAY;
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(KeySession.prototype, "isPlayready", {
          get: function() {
            return this.keySystem === ht.PLAYREADY;
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(KeySession.prototype, "isWidevine", {
          get: function() {
            return this.keySystem === ht.WIDEVINE;
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        (KeySession.prototype.dispatchKeyError = function(e) {
          this.dispatchEvent(ft.playbackSessionError, new ee(ee.MEDIA_KEY, e));
        }),
        (KeySession.prototype.dispatchSessionError = function(e) {
          this.dispatchEvent(
            ft.playbackSessionError,
        ...
        (KeySession.prototype._handleLicenseResponse = function(e, t, r) {
          ...
          this.dispatchEvent(ft.playbackLicenseError, o);
        }),
        KeySession
      );
    })(ke),
      ...
      return (
        ...
        (MSSession.prototype.attachMedia = function(e, t) {
          ...
          return (
            ...
            e.addEventListener("mskeyerror", function(e) {
        ...
        (MSSession.prototype.createSession = function(e) {
          ...
          var n = r.msKeys.createSession(pt.MP4, t);
          return (
        ...
        (WebKitSession.prototype.createSession = function(e) {
          ...
          return this.loadCertificateBuffer().then(function(e) {
            var n = t._concatInitDataIdAndCertificate(r, o, e),
              a = i.webkitKeys.createSession(pt.MP4, n);
            (a.contentId = o),
    ...
    Et = (function(e) {
      function MediaExtension(t, r) {
        ...
        if (
          ...
          window.WebKitMediaKeys.isTypeSupported(ht.FAIRPLAY + ".1_0", pt.MP4)
        )
          (i.session = new wt()),
            i.session.attachMedia(t, { keySystem: ht.FAIRPLAY });
        else if (
          window.MSMediaKeys &&
          window.MSMediaKeys.isTypeSupported(ht.PLAYREADY, pt.MP4)
        )
          (i.session = new Pt()),
            i.session.attachMedia(t, { keySystem: ht.PLAYREADY });
          ...
          navigator
            .requestMediaKeySystemAccess(ht.WIDEVINE, n)
            .then(function(e) {
              i.session.attachMedia(t, e);
            })
            .catch(function() {
              navigator
                .requestMediaKeySystemAccess(ht.PLAYREADY, n)
                .then(function(e) {
                  i.session.attachMedia(t, e);
                });
            });
        ...
        return (
          i.session &&
            i.session.addEventListener(ft.playbackLicenseError, function(e) {
              i.dispatchEvent(ft.playbackLicenseError, e);
            }),
          i
        );
      }
  ...
  var It = Ve.mediaItemStateDidChange,
    St = Ve.mediaItemStateWillChange,
    Tt = (function(e) {
      function MediaItem(t) {
        void 0 === t && (t = {});
        var r = e.call(this, [It, St]) || this;
        (r._assets = []), (r._isPlayable = !0), (r._state = bt.none);
        return (
          t.id && t.attributes
            ? (Object.assign(r, t),
              (r.type =
      ...
      return (
        ...
        Object.defineProperty(MediaItem.prototype, "isRestricted", {
          get: function() {
            return this.state === bt.restricted;
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(MediaItem.prototype, "isUnavailable", {
          get: function() {
            return this.state === bt.unavailable;
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(MediaItem.prototype, "previewURL", {
          get: function() {
            return He(this, "attributes.previews.0.url");
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(MediaItem.prototype, "releaseDate", {
          get: function() {
            if (
              this.attributes &&
              /^\d{4}-\d{1,2}-\d{1,2}/.test(this.attributes.releaseDate)
            )
              return new Date(this.attributes.releaseDate);
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(MediaItem.prototype, "state", {
          ...
          set: function(e) {
            ...
            this._stateWillChange && this._stateWillChange(this),
              this.dispatchEvent(St, t),
              (this._state = e),
              this._stateDidChange && this._stateDidChange(this),
              this.dispatchEvent(It, t);
          },
          enumerable: !0,
          configurable: !0
        }),
                  ...
                  if (((s = d.sent()), !(u = JSON.parse(s)) || !u.songList)) {
                    switch ((c = ee.serverError(u)).errorCode) {
                      case ee.CONTENT_RESTRICTED:
                        this.state = bt.restricted;
                        break;
                      case ee.CONTENT_UNAVAILABLE:
                        this.state = bt.unavailable;
                        break;
                      default:
                        this.state = bt.error;
                    }
  ...
  var kt,
    At,
    Ot = Ve.queueItemsDidChange,
    Ct = Ve.queuePositionDidChange,
    Rt = (function(e) {
      function Queue(t) {
        var r = e.call(this, [Ot, Ct]) || this;
        return (
          (r._itemIDs = []),
          (r._items = []),
          (r._isRestricted = !1),
          ...
          t
            ? ((r._items = r._descriptorToMediaItems(t)),
              isNaN(t.startPosition) || (r._position = t.startPosition),
              r._reindex(),
              r)
            : r
        );
      ...
      return (
        ...
        (Queue.prototype.append = function(e) {
          ...
          (t = this._items).push.apply(t, i),
            ...
            this.dispatchEvent(Ot, this._items);
        }),
        ...
        (Queue.prototype.shuffle = function(e) {
          ...
          this._reindex(), e && this.dispatchEvent(Ot, this._items);
        }),
                        ...
                        var t = Ye(
                          {
                            ...
                            "attributes.contentRating": function() {
                              if (1 === He(e, "metadata.isExplicit")) return ve;
                            },
                            "attributes.playParams": function() {
                              return (
                                0 !== He(e, "metadata.isPlayable") && {
                                  id: He(e, "metadata.itemId"),
                                  kind: He(e, "metadata.itemType")
                                }
                              );
                            },
        ...
        (Queue.prototype._resourceToMediaItem = function(e) {
          if (
            ...
            var t,
              r = (void 0 === (n = e.relationships.tracks.data) && (n = []),
              0 !== n.length &&
                n.filter(function(e) {
                  var t = e.attributes;
                  return (
  ...
  var Mt = "mk-player-tsid",
    Lt = Ve.bufferedProgressDidChange,
    Nt = Ve.mediaCanPlay,
    xt = Ve.mediaItemDidChange,
    Ut = Ve.mediaItemStateDidChange,
    jt = Ve.mediaItemStateWillChange,
    Bt = Ve.mediaItemWillChange,
    Kt = Ve.mediaPlaybackError,
    zt = Ve.metadataDidChange,
    qt = Ve.primaryPlayerDidChange,
    Vt = Ve.playbackDurationDidChange,
    Ft = Ve.playbackProgressDidChange,
    Ht = Ve.playbackTimeDidChange,
    Yt = Ve.playbackVolumeDidChange,
    Wt = Ve.queueItemsDidChange,
    Gt = Ve.queuePositionDidChange,
    Qt = e.PlaybackStates.completed,
    Xt = e.PlaybackStates.ended,
    Zt = e.PlaybackStates.loading,
    Jt = e.PlaybackStates.paused,
    $t = e.PlaybackStates.playing,
    er = e.PlaybackStates.seeking,
    tr = e.PlaybackStates.stopped,
    rr = e.PlaybackStates.waiting,
    ir = (function(t) {
      function Player(r) {
        var i =
          t.call(this, [
        ...
        (i.privateEnabled = !1),
          ...
          (i._paused = !1),
          (i._queue = new Rt({})),
          (i._repeatMode = kt.none),
          (i._serial = Date.now().toString()),
          (i._shuffleMode = At.off),
          (i._stopped = !1),
          (i._nowPlayingItem = null),
          (i._bitrate = r.bitrate || e.PlaybackBitrate.STANDARD),
          window.navigator &&
            window.navigator.connection &&
            window.navigator.connection.downlink &&
            i.recalculateBitrate(
              100 * (window.navigator.connection.downlink || 0)
            ),
          (i.storekit = r.storekit),
          (i.privateEnabled = r.privateEnabled || !1),
          (i.siriInitiated = r.siriInitiated || !1);
        ...
        (n.autoplay = !1),
          ...
          (n.preload = "metadata"),
          (n.volume = 1),
          n.addEventListener("canplay", function(e) {
            return i.dispatchEvent(Nt, e);
          }),
          n.addEventListener("durationchange", function(e) {
            i.audio.duration !== 1 / 0 &&
              ((e.duration = i.currentPlaybackDuration),
              i.dispatchEvent(Vt, e),
              i._calculatePlaybackProgress());
          }),
          ...
          n.addEventListener("progress", function(e) {
            ...
            1 === t.length &&
              0 === t.start(0) &&
              (i.currentBufferedProgress = Math.round(
                (t.end(0) / i.currentPlaybackDuration) * 100
              ));
          }),
          ...
          n.addEventListener("seeking", function() {
            i.playbackState === Jt
              ? (i._paused = !0)
              : i.playbackState === tr && (i._stopped = !0),
              (i.playbackState = er);
          }),
          n.addEventListener("timeupdate", function(e) {
            i.dispatchEvent(Ht, {
              ...
              i._calculatePlaybackProgress(),
              i._buffer && (i._buffer.currentTime = i.currentPlaybackTime);
          }),
          n.addEventListener("volumechange", function(e) {
            return i.dispatchEvent(Yt, e);
          }),
          n.addEventListener("waiting", function() {
            return (i.playbackState = rr);
          }),
          window.WebKitPlaybackTargetAvailabilityEvent &&
            n.addEventListener(
          ...
          (i.extension = new Et(n, Pe)),
          i.extension.addEventListener(ft.playbackLicenseError, function(e) {
            i.dispatchEvent(Kt, e);
          }),
          i.extension.addEventListener(ft.playbackSessionError, function(e) {
            i.dispatchEvent(Kt, new ee(ee.MEDIA_SESSION, e));
          });
        var o = "visibilitychange",
          a = "visibilityState";
        void 0 !== document.mozHidden
          ? ((o = "mozvisibilitychange"), (a = "mozVisibilityState"))
          : void 0 !== document.msHidden
          ? ((o = "msvisibilitychange"), (a = "msVisibilityState"))
          : void 0 !== document.webkitHidden &&
            ((o = "webkitvisibilitychange"), (a = "webkitVisibilityState")),
          document.addEventListener(o, function(e) {
            return (
              we.logger.log("visibilityState", e.target[a]),
              "hidden" === e.target[a]
                ? i.isPlaying && i._playActivity.exit(i.currentPlaybackTime)
                : "visible" === e.target[a]
        ...
        return (
          ...
          window.addEventListener(
            ...
            function(e) {
              var t = e.key,
                r = e.newValue;
              t === Mt && r && (i.isPrimaryPlayer = r === i._serial);
            },
            !1
          ),
          localStorage.setItem(Mt, i._serial),
          setTimeout(function() {
            i._playActivity.activate(!i.isPlaying);
          }, 500),
      ...
      return (
        __extends(Player, t),
        Object.defineProperty(Player.prototype, "canSupportDRM", {
          get: function() {
        ...
        Object.defineProperty(Player.prototype, "currentBufferedProgress", {
          ...
          set: function(e) {
            this._currentBufferedProgress !== e &&
              ((this._currentBufferedProgress = e),
              this.dispatchEvent(Lt, { progress: e }));
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(Player.prototype, "currentPlaybackDuration", {
          get: function() {
            return !this.previewOnly &&
              ...
              ? Math.round(this.nowPlayingItem.playbackDuration / 1e3)
              : Math.round(this.audio.duration || 0);
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(Player.prototype, "currentPlaybackProgress", {
          ...
          set: function(e) {
            this._currentPlaybackProgress !== e &&
              ((this._currentPlaybackProgress = e),
              this.dispatchEvent(Ft, { progress: e }));
          },
          enumerable: !0,
          configurable: !0
        }),
          ...
          set: function(e) {
            (this._isPrimaryPlayer = e),
              this._isPrimaryPlayer
                ? localStorage.setItem(Mt, this._serial)
                : (this.dispatchEvent(qt, { target: this }), this.pause());
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(Player.prototype, "queue", {
          ...
          set: function(e) {
            ...
            this.hasAuthorization &&
              ...
              this.shuffleMode === At.songs && e.shuffle(!1),
              (this.nowPlayingItem = null);
            var r = e.item(e.position);
            r &&
              r.isPlayable &&
              this.prepareToPlay(r).then(function(e) {
                t.nowPlayingItem = e;
              }),
              e.addEventListener(Wt, function(e) {
                return t.dispatchEvent(Wt, e);
              }),
              e.addEventListener(Gt, function(e) {
                return t.dispatchEvent(Gt, e);
              }),
              (this._queue = e),
              this.dispatchEvent(Wt, e.items);
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(Player.prototype, "repeatMode", {
          ...
          set: function(e) {
            (this._repeatMode = e),
              "boolean" == typeof this.audio.loop &&
                (this.audio.loop = this._repeatMode === kt.one);
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(Player.prototype, "shuffle", {
          set: function(e) {
            this.shuffleMode = e ? At.songs : At.off;
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(Player.prototype, "shuffleMode", {
          ...
          set: function(e) {
            (this._shuffleMode = e), e === At.songs && this.queue.shuffle();
          },
          enumerable: !0,
          configurable: !0
        }),
                    ...
                    switch (e.label) {
                      case 0:
                        return this.isPlaying
                          ? r > Ke.DENIED && i < Ke.RESTRICTED
                            ? [4, this._stop(se.PLAYBACK_SUSPENDED)]
                            : [3, 2]
                          : [3, 3];
                      case 1:
        ...
        Object.defineProperty(Player.prototype, "_playActivity", {
          get: function() {
            return this._storekit && this._storekit.userTokenIsValid
            ...
            __awaiter(this, void 0, void 0, function() {
              return __generator(this, function(t) {
                return (
                  (this._paused = !1),
                  (this._stopped = !1),
                  [2, this._changeToMediaAtIndex(e, !0)]
                );
              });
            })
          );
              ...
              switch (e.label) {
                case 0:
                  return this.isPlaying
                    ? (this.audio.pause(),
                      (this._paused = !0),
                      [4, this._playActivity.pause(this.currentPlaybackTime)])
                    : [3, 2];
                case 1:
                  e.sent(), (e.label = 2);
                case 2:
              ...
              switch (t.label) {
                ...
                case 2:
                  if (!this.queue.isEmpty)
                    return -1 === this.queue.nextPlayableItemIndex &&
                      (e = this.queue.nextPlayableItem)
                      ? [2, this.changeToMediaItem(e)]
                      : [
                          2,
                          this.changeToMediaAtIndex(
              ...
              return __generator(this, function(n) {
                switch (n.label) {
                  ...
                  case 12:
                    return t
                      ? [2, Promise.reject(r)]
                      : (this.dispatchEvent(Kt, r),
                        (i =
                          -1 ===
                          [ee.DEVICE_LIMIT, ee.STREAM_UPSELL].indexOf(
                            r.errorCode
                          )),
                        this.continuous && i ? [2, this._next()] : [2]);
                  case 13:
                    return (
              ...
              switch (r.label) {
                ...
                case 2:
                  return (
                    ...
                    [4, this._playActivity.scrub(t)]
                  );
                case 3:
                  return (
                    r.sent(), this._playActivity.scrub(e, se.SCRUB_END), [2]
                  );
              }
            });
          });
              ...
              switch (t.label) {
                case 0:
                  return (
                    (this._stopped = !0),
                    this.audio.pause(),
                    [4, this._playActivity.stop(this.currentPlaybackTime, e)]
                  );
                case 1:
                  return (
                    t.sent(),
                ...
                switch (l.label) {
                  case 0:
                    ...
                    (this.queue.position = e),
                      (i = this.currentPlaybackTime),
                      (n = this.playbackState),
                      (o = this.queue.item(e)),
                      (l.label = 1);
                  case 1:
                    return (
                      l.trys.push([1, 3, , 4]), [4, this._playMediaItem(o, t)]
                    );
                  case 2:
                    return (
                      l.sent(),
                      "song" !== o.type
                        ...
                        : ((a = {
                          ...
                          (s =
                            r === se.TRACK_SKIPPED_BACKWARDS ||
                            r === se.TRACK_SKIPPED_FORWARDS),
                          t && n === $t && s
                            ? [2, this._playActivity.skip(a, r, i)]
                            : ((u = (s || t) && n !== $t),
                              [2, this._playActivity.play(a, u ? 0 : i)]))
                    );
                  case 3:
                ...
                switch (t.label) {
                  case 0:
                    return this.queue.isEmpty
                      ? [2]
                      : this.repeatMode !== kt.one
                      ? [3, 1]
                      : "boolean" != typeof this.audio.loop
                      ? (this.seekToTime(0), [2, this.play()])
                      : [3, 6];
                  case 1:
                    return this.queue.nextPlayableItem
                      ? [
                          2,
                      ...
                      : [3, 2];
                  case 2:
                    return this.repeatMode !== kt.all
                      ? [3, 3]
                      : [2, this._changeToMediaAtIndex(0, !1)];
                  case 3:
                    return this.isPlaying
                      ? [4, this._stop(se.TRACK_SKIPPED_FORWARDS)]
                      : [3, 5];
                  case 4:
                    t.sent(), (this.nowPlayingItem = null), (t.label = 5);
                  case 5:
                    (this.playbackState = Qt), (t.label = 6);
                  case 6:
                    return [2];
                }
              });
                  ...
                  case 0:
                    return e && e.isPlayable
                      ? (e.beginMonitoringStateDidChange(function(e) {
                          return o.dispatchEvent(Ut, e);
                        }),
                        e.beginMonitoringStateWillChange(function(e) {
                          return o.dispatchEvent(jt, e);
                        }),
                        (r = this._paused && !t),
                        this.previewOnly || !this.hasAuthorization
                          ? ((this.nowPlayingItem = e),
                            (this.audio.src = e.previewURL),
                            r ? [2, this.audio.load()] : [2, this.audio.play()])
                          : this.extension.hasMediaSession
                          ? (this.audio.load(), [4, this.prepareToPlay(e, t)])
                          : [2])
                      : [
                          2,
                          Promise.reject(
                    ...
                    return (
                      ...
                      e.playRawAssetURL
                        ...
                        : ((this.extension.initiated = t),
                          ...
                          (this.nowPlayingItem = e),
                          (e.state = bt.loading),
                          [4, yt.load(e.assetURL, !1)])
                    );
                  case 2:
                    return (
                      (i = a.sent()),
                      (this.extension.extURI = i.extURI),
                      (e.state = bt.ready),
                      this.extension.isFairplay
                        ? [2, this._playAssetURL(e.assetURL, r)]
                        : (i.downlink && this.recalculateBitrate(i.downlink),
                          this._buffer && this._buffer.remove(),
                          (n = new MediaSource()),
                          (this.audio.src = window.URL.createObjectURL(n)),
                          this.audio.load(),
                          n.addEventListener("sourceopen", function(t) {
                            0 === n.activeSourceBuffers.length &&
                              ((o._buffer = new Dt({
                                duration: e.playbackDuration / 1e3,
                                mediaSource: n,
                                manifest: i
                              })),
                              r || o.playbackState === Jt || o.audio.play());
                          }),
                          [2])
                    );
                }
          ...
          return (
            ...
            __awaiter(this, void 0, void 0, function() {
              return __generator(this, function(t) {
                return this.queue.isEmpty
                  ? [2]
                  : this.queue.previousPlayableItem
                  ? [
                      2,
                      this._changeToMediaAtIndex(
    ...
    or = (function(t) {
      function MusicKitInstance(r, i) {
        ...
        Object.assign(we.features, Ie(i.features)),
        ...
        (MusicKitInstance.prototype.changeToMediaAtIndex = function(e) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(t) {
              switch (t.label) {
                case 0:
                  return 0 !== this.player.audio.readyState
                    ? [3, 2]
                    : [4, this.authorize()];
                case 1:
                  t.sent(), (t.label = 2);
              ...
              switch (t.label) {
                case 0:
                  return this.player.playbackState ===
                    e.PlaybackStates.playing ||
                    0 !== this.player.audio.readyState
                    ? [3, 2]
                    : [4, this.player.audio.load()];
                case 1:
                  t.sent(), (t.label = 2);
                case 2:
                  return [2];
              ...
              switch (u.label) {
                case 0:
                  ...
                  return (
                    ...
                    (o = e.songs ? e.songs[0] : e.album || e.playlist)
                      ? ((a = isLibraryType(o)),
                        (s = a ? this.api.library : this.api),
                        a ? [4, this.authorize()] : [3, 2])
                      : [3, 3]
                  );
                case 1:
                  u.sent(), (u.label = 2);
    ...
    ur = (function() {
      function DOMSupport(e, t) {
        void 0 === e && (e = void 0), void 0 === t && (t = ar.classes);
        var r = this;
        if (
          ((this.elements = e),
          (this.classes = t),
    ...
    cr = /^http(?:s)?\:\/\/(?:itunes|embed\.music)\.apple\.com/i,
    lr = [
      "allow-forms",
      "allow-popups",
      "allow-same-origin",
  ...
  var dr,
    pr = ee.errors,
    hr = "undefined" != typeof window && "undefined" != typeof document,
    fr = "apple-music-now-playing";
          ...
          "data-apple-music-now-playing": {
            content: function(e) {
              var r = e.dataset.appleMusicNowPlaying || "info",
                i = He(t.player.nowPlayingItem, r);
  ...
  if (hr) {
    ...
    var yr = (function() {
      ...
      mr = /interactive|complete|loaded/.test(document.readyState);
    yr &&
      yr.developerToken &&
      !mr &&
      !dr &&
      ((yr.declarativeMarkup = !0),
  ...
  (e.errors = pr),
    ...
    (e.getInstance = function() {
      if (!dr) throw new ee(ee.CONFIGURATION_ERROR, "No configured instance");
      return dr;
    }),
    (e.Queue = Rt),
    (e.version = nr),
    ...
    (e.generateEmbedCode = function(e, t) {
      if ((void 0 === t && (t = { height: "450", width: "660" }), !cr.test(e)))
